...
use super::{
    dashboard,
    models::{
        AddReplyRequest, CreateTicketRequest, DeskDashboardResponse, ReplyResponse, TicketResponse,
    },
};

const SOURCE: &str = "desk";

pub async fn get_dashboard_summary(
    State(state): State<AppState>,
) -> Result<Json<DeskDashboardResponse>, (StatusCode, String)> {
